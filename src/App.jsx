...
import { Search, Activity, ExternalLink, Globe } from 'lucide-react';
...
const ApiCard = ({ api }) => {
  ...
  // We'll use a green dot for 'Pulse' status as requested
  const isHealthy = true;

  return (
    <div className="glass-panel rounded-xl p-6 transition-all duration-300 hover:scale-[1.02] hover:neon-glow-cyan group relative overflow-hidden">
      ...
      <div className="flex flex-col h-full mt-2">
        <h3 className="text-xl font-bold text-white mb-1 group-hover:text-neon-cyan transition-colors">{api.name}</h3>
